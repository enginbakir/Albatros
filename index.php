                           ...
                           /* $student_query= mysql_query("select * from student");
                            ...
                            while($student = mysql_fetch_assoc($student_query)){
                              */
                              ...
                              $sqlQuery = $connection->query("SELECT * FROM student",PDO::FETCH_ASSOC);

                              foreach ($sqlQuery as $students) {
                                # code...                              
                                ...
                                <tr>
                                  ...
                                  <td class="id"> <?php echo $students['student_PK']; ?> </td>
                                  <td class="isim"> <?php echo $students['name']; ?> </td>
                                  <td class="soyisim"> <?php echo $students['surname']; ?> </td>
                                  <td>Kawdawız</td>
                                  <td>231</td>
                                  <td>C</td>
                                </tr>
