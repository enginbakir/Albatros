...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  ///////////////////////////////////
                          ...
                          if (!isset($name) && !isset($surname)) {
                            $sql = "SELECT student_PK,name,surname FROM student LIMIT $offset, $rec_limit";
                          }
                    ...
                    <div class="col col-xs-4"> <?php echo "Kayıtlı Öğrenci Sayısı: ".$num_rows ?>
                    </div>
