				...
				<div class="row">
					<div class="col-md-12">
						<div class="row">
									...
									<div class="box-body">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<table id="studentListTable" class="table table-bordered table-hover table-striped table-condens formatHTML5 "> 
                           ...
                           /* $student_query= mysql_query("select * from student");

                            while($student = mysql_fetch_assoc($student_query)){
                              */
                            	...
                            	while($row = mysql_fetch_array($retval, MYSQL_ASSOC)) {
                            		?>
                            		<tr> 
                            			<td class="id"><?php echo $row['student_PK']; ?></td> 
                            			<td class="isim"> <?php echo $row['name']; ?> </td>
                            			<td class="soyisim"> <?php echo $row['surname']; ?> </td>
                            			<td>12</td>
                            			<td>Kawdawız</td>
                            			<td>231</td>
                            			<td>C</td>
                    ...
                    <div class="col col-xs-4"> <?php 
                    echo "<p>Kayıtlı Öğrenci Sayısı: ".$num_rows."</p>";
                    ?>
                </div>
                <div class="col col-xs-8">
                	<ul class="pagination hidden-xs pull-right">
                		...
                		if( $page > 0 ) {
                			$last = $page - 2;
                    					//echo "Page: ".$page."<br>";
                    					//echo "Last: ".$last."<br>";
                			echo "<li><a href=".$_SERVER['PHP_SELF']."?page=".$last.">Last 10 Records</a></li>";
                			echo "<li><a href=".$_SERVER['PHP_SELF']."?page=".$page.">Next 10 Records</a></li>";
           		...
           		//echo "<a href=".$_SERVER['PHP_SELF']."?page=".$value." >engin</a>";
                		...
                		?>
                    				...
                    				<!-- <li><a href="<?php //echo $_SERVER['PHP_SELF'] . '?page=2'; ?>">Previous Page</a></li>
                    					<li><a href="<?php //echo $_SERVER['PHP_SELF'] . '?page=3'; ?>">Next Page</a></li> -->
...
<script>
	...
	$(document).ready(function () {
		$("#searchStudent").on("click",function(){
			...
			var StudentName = document.getElementById("adi").value;
			var StudentSurname = document.getElementById("soyadi").value;


			if(document.getElementById("adi").value && document.getElementById("soyadi").value){
				StudentName = document.getElementById("adi").value;
				StudentSurname = document.getElementById("soyadi").value;
				query = "SELECT * FROM student where name="+ StudentName +" and surname="+StudentSurname+";";
			...
			else if(document.getElementById("soyadi").value){
				StudentSurname = document.getElementById("soyadi").value;
				query = "SELECT * FROM student where surname ="+ StudentSurname +";";
...
/*
    ...
    hiddenField.setAttribute("name", sqlQuery);
    ...
    for(var key in query) {
    	if(query.hasOwnProperty(key)) {
    		...
    		hiddenField.setAttribute("value", query[key]);
