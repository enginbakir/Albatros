  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>Ö</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Öğrenci</b></span>
      </a>
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="dist/img/avatar3.png" class="img-circle" alt="User Image" style="max-width: 100px ; margin-left: 50px">
          </div>
        </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="#menu4">
              ...
              <span style="font-size: 17px">Mail</span>
            </a>
          </li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-12">
                <!-- /.box -->
                <div class="box" style="margin: auto; width: 700px">
